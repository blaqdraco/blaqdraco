...
3) Open `tools/ascii-portrait.txt`, copy its contents, and replace the block between `START:ASCII-PORTRAIT` and `END:ASCII-PORTRAIT` near the top of this README.
